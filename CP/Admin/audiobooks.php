...
<body>
  ...
  <main>
    <div class="book">
	  ...
	  <audio controls src="images/blackbeauty-01-sewell-64kb.mp3"></audio>
    ...
    <div class="book">
	  ...
	  <audio controls src="images/frankenstein_01_shelley_64kb.mp3"></audio> 
	  <a href="booking.php" class="book-button">Add to Order</a>
    </div>
    ...
    <div class="book">
      ...
      <audio controls src="images\the_cosmic_comp.mp3"></audio> 
      <a href="booking.php" class="book-button">Add to Order</a>
    </div>
    <div class="book">
      ...
      <audio controls src="images\legendofsleepyhollow.mp3"></audio>
      <a href="booking.php" class="book-button">Add to Order</a>
